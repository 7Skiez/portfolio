    ...
    return axios.get("/api/data").then((response) => {
        ...
        function RadarChart(id, data, options) {
            var cfg = {
                ...
                dotRadius: parseFloat(response.data.chart.dotRadius), //The size of the colored circles of each blog
                opacityCircles: 0.1, //The opacity of the circles of each blob
                strokeWidth: parseFloat(response.data.chart.strokeWidth), //The width of the stroke around each blob
            };
        ...
        const radarItems = response.data.chart.items;

        var data = [[]];

        let roundStrokes = response.data.chart.roundness
            ? JSON.parse(response.data.chart.roundness.toLowerCase())
            : false;
        ...
        svgLinearGradient(response.data.chart.gradient, { id: "#" + response.data.chart.id });
