...
@if ($ivno)
    <footer x-data="{ 'showModal': false }" @keydown.escape="showModal = false">
                ...
                <div class="flex flex-col items-center py-3">
                    ...
                    <div class="absolute bottom-0 translate-y-1/2 flex w-full justify-center">
                        <div class="flex justify-around w-4/5">
                            ...
                            <a href="https://www.linkedin.com/in/mohammad-javad-r-876077b6" target="_blank" class="backdrop-blur-lg hover:bg-[#1877f2] w-9 h-9 fill-[#1877f2] hover:fill-white border-blue-200 rounded-full flex items-center justify-center shadow-xl hover:shadow-blue-500/50 cursor-pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 30 30">
                                    <path d="M9,25H4V10h5V25z M6.501,8C5.118,8,4,6.879,4,5.499S5.12,3,6.501,3C7.879,3,9,4.121,9,5.499C9,6.879,7.879,8,6.501,8z M27,25h-4.807v-7.3c0-1.741-0.033-3.98-2.499-3.98c-2.503,0-2.888,1.896-2.888,3.854V25H12V9.989h4.614v2.051h0.065 c0.642-1.18,2.211-2.424,4.551-2.424c4.87,0,5.77,3.109,5.77,7.151C27,16.767,27,25,27,25z" />
                                </svg>
                            </a>

                            <a href="https://github.com/7Skiez" target="_blank" class="backdrop-blur-lg hover:bg-[#1d9bf0] w-9 h-9 fill-[#1d9bf0] hover:fill-white border-blue-200 rounded-full flex items-center justify-center shadow-xl hover:shadow-sky-500/50 cursor-pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 30 30">
                                    <path
                            ...
                            <a href="https://www.instagram.com/7skiez" target="_blank" class="backdrop-blur-lg hover:bg-[#bc2a8d] w-9 h-9 fill-[#bc2a8d] hover:fill-white border-pink-200 rounded-full flex items-center justify-center shadow-xl hover:shadow-pink-500/50 cursor-pointer">
                            ...
                            <a href="mailto:id4mjr@gmail.com" target="_blank" class="backdrop-blur-lg hover:bg-[#25D366] w-9 h-9 fill-[#25D366] hover:fill-white border-green-200 rounded-full flex items-center justify-center shadow-xl hover:shadow-green-500/50 cursor-pointer">
                            ...
                            <a href="https://t.me/sevenskies" target="_blank" class="backdrop-blur-lg hover:bg-[#229ED9] w-9 h-9 fill-[#229ED9] hover:fill-white border-sky-200 rounded-full flex items-center justify-center shadow-xl hover:shadow-sky-500/50 cursor-pointer">
        ...
        <div class="flex justify-center items-end w-full bg-glow h-max max-h-[25rem] xl:max-h-[60rem] overflow-hidden text-center mx-auto -mt-48">
            ...
            <p class="absolute text-xs text-accent mb-2">Made With ❤️ By <a @click="showModal = true" class="font-bold text-base gradient text-gradient cursor-pointer">MosbatSaz</a> Team | {{ date('Y') }}</p>
        </div>
    </footer>
