                                    ...
                                    @elseif($setting->type == "image" || $setting->type == "file")
                                        @if(isset( $setting->value ) && !empty( $setting->value ) && Storage::disk(config('voyager.storage.disk'))->exists($setting->value))
                                            <div class="img_settings_container">
                                                ...
                                                <img src="{{ image($setting->value) }}" style="width:200px; height:auto; padding:2px; border:1px solid #ddd; margin-bottom:10px;">
                                            </div>
                ...
                <form action="{{ route('voyager.settings.store') }}" method="POST">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="type" class="form-control" required="required">
                            ...
                            <option value="color">Color Editor</option>
                            <option value="gradient">Gradient Editor</option>
