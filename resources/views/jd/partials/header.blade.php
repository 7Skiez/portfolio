                ...
                <a href="#hero" class="flex items-center justify-center space-x-3 transition-all duration-1000 ease-out transform">
                    @if(settingImage('logo'))
                        <h1 class="text-xl font-extrabold tracking-widest">
                            <span class="text-transparent bg-clip-text bg-gradient-to-r from-pink-600 via-fuchsia-600 to-purple-600">jd&#62;</span><span class="@if(Portfolio::setting('jd.logo_blink')) animate-blink @endif text-purple-600">_</span>~
                        </h1>
                        <img class="w-8 h-8 object-scale-down" src="{{ settingImage('logo') }}" alt="ivno.logo">
                    @else
